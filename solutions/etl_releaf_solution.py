...
def etl_releaf():
    ...
    final_data = generate_tree_recommendations(transformed_data)
    load_task = load_user_data(final_data)
    summary_task = summarize_onboarding(final_data)

    chain(user_data, transformed_data, final_data, load_task, summary_task)
